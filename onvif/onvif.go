...
type Base64Binary struct {
	XMLName xml.Name `xml:"http://www.w3.org/2005/05/xmlmime Data"`
...
type Fault struct {
	...
	Node xsd.AnyURI `xml:"Node,omitempty" json:"Node,omitempty"`

	Role xsd.AnyURI `xml:"Role,omitempty" json:"Role,omitempty"`
...
type Subcode struct {
	...
	Value *xsd.QName `xml:"Value,omitempty" json:"Value,omitempty"`
...
type NotUnderstoodType struct {
	...
	Qname *xsd.QName `xml:"http://www.w3.org/2003/05/soap-envelope qname,attr,omitempty" json:"qname,omitempty"`
}

type SupportedEnvType struct {
	XMLName xml.Name `xml:"http://www.w3.org/2003/05/soap-envelope SupportedEnvelope"`
...
type RelationshipType xsd.AnyURI
...
type ReferenceParametersType struct {
	XMLName xml.Name `xml:"http://www.w3.org/2005/08/addressing ReferenceParameters"`
...
type RelatesToType struct {
	...
	Value xsd.AnyURI `xml:",chardata" json:"-,"`
...
type AttributedQNameType struct {
	...
	Value *xsd.QName `xml:",chardata" json:"-,"`
}
...
type ProblemActionType struct {
	...
	SoapAction xsd.AnyURI `xml:"SoapAction,omitempty" json:"SoapAction,omitempty"`
}
...
type BaseFaultType struct {
	...
	ErrorCode struct {
		...
		Dialect xsd.AnyURI `xml:"http://docs.oasis-open.org/wsrf/bf-2 dialect,attr,omitempty" json:"dialect,omitempty"`
...
type SimpleTopicExpression xsd.QName
...
type Documentation struct {
	XMLName xml.Name `xml:"http://docs.oasis-open.org/wsn/t-1 documentation"`
...
type QueryExpressionType struct {
	...
	Dialect xsd.AnyURI `xml:"Dialect,attr,omitempty" json:"Dialect,omitempty"`
}
...
type TopicNamespaceType struct {
	...
	*ExtensibleDocumented
	...
	Name xsd.NCName `xml:"http://docs.oasis-open.org/wsn/t-1 name,attr,omitempty" json:"name,omitempty"`

	TargetNamespace xsd.AnyURI `xml:"http://docs.oasis-open.org/wsn/t-1 targetNamespace,attr,omitempty" json:"targetNamespace,omitempty"`

	Final bool `xml:"http://docs.oasis-open.org/wsn/t-1 final,attr,omitempty" json:"final,omitempty"`
}

type TopicType struct {
	XMLName xml.Name `xml:"http://docs.oasis-open.org/wsn/t-1 Topic"`
...
type GetMessages struct {
	...
	MaximumNumber *xsd.NonNegativeInteger `xml:"MaximumNumber,omitempty" json:"MaximumNumber,omitempty"`
...
type TopicExpressionType struct {
	...
	Dialect xsd.AnyURI `xml:"http://docs.oasis-open.org/wsn/b-2 Dialect,attr,omitempty" json:"Dialect,omitempty"`
}
...
type InvalidFilterFaultType struct {
	...
	*BaseFaultType
	...
	UnknownFilter []*xsd.QName `xml:"UnknownFilter,omitempty" json:"UnknownFilter,omitempty"`
}
...
type UnrecognizedPolicyRequestFaultType struct {
	...
	*BaseFaultType
	...
	UnrecognizedPolicy []*xsd.QName `xml:"UnrecognizedPolicy,omitempty" json:"UnrecognizedPolicy,omitempty"`
}
...
type UnsupportedPolicyRequestFaultType struct {
	...
	*BaseFaultType
	...
	UnsupportedPolicy []*xsd.QName `xml:"UnsupportedPolicy,omitempty" json:"UnsupportedPolicy,omitempty"`
}
...
type Include struct {
	...
	Href xsd.AnyURI `xml:"http://www.w3.org/2004/08/xop/include href,attr,omitempty" json:"href,omitempty"`
}
...
type Vector2D struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema PanTilt"`
	...
	Space xsd.AnyURI `xml:"http://www.onvif.org/ver10/schema space,attr,omitempty" json:"space,omitempty"`
}

type Vector1D struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema Zoom"`
...
type PTZMoveStatus struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema MoveStatus"`
...
type Color struct {
	...
	Colorspace xsd.AnyURI `xml:"http://www.onvif.org/ver10/schema Colorspace,attr,omitempty" json:"Colorspace,omitempty"`
...
type ColorCovariance struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema Covariance"`
...
type TransformationExtension struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema Extension"`
...
type LocationEntity struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema Location"`
	...
	GeoSource xsd.AnyURI `xml:"http://www.onvif.org/ver10/schema GeoSource,attr,omitempty" json:"GeoSource,omitempty"`
...
type IntRectangle struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema Bounds"`
...
type DurationRange struct {
	Min *xsd.Duration `xml:"Min,omitempty" json:"Min,omitempty"`

	Max *xsd.Duration `xml:"Max,omitempty" json:"Max,omitempty"`
}
...
type LensProjection struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema Projection"`
...
type LensOffset struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema Offset"`
...
type RotateOptions struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema Rotate"`
...
type VideoEncoderConfiguration struct {
	*ConfigurationEntity
	...
	SessionTimeout *xsd.Duration `xml:"SessionTimeout,omitempty" json:"SessionTimeout,omitempty"`
...
type VideoRateControl struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema RateControl"`
...
type Mpeg4Configuration struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema MPEG4"`
...
type H264Configuration struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema H264"`
...
type JpegOptions struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema JPEG"`
...
type AudioEncoderConfigurationOptions struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema AudioEncodingCapabilities"`
...
type AudioEncoderConfigurationOption struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema Options"`
...
type PTZFilter struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema PTZStatus"`
...
type VideoDecoderConfigurationOptions struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema VideoDecodingCapabilities"`
...
type AudioOutputConfiguration struct {
	*ConfigurationEntity
	...
	SendPrimacy xsd.AnyURI `xml:"SendPrimacy,omitempty" json:"SendPrimacy,omitempty"`
...
type AudioOutputConfigurationOptions struct {
	...
	// The following modes for the Send-Primacy are defined:
	// Acoustic echo cancellation is out of ONVIF scope.
	SendPrimacyOptions []xsd.AnyURI `xml:"SendPrimacyOptions,omitempty" json:"SendPrimacyOptions,omitempty"`
...
type AudioDecoderConfigurationOptions struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema AudioDecodingCapabilities"`
...
type MulticastConfiguration struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema Multicast"`
...
type MediaUri struct {
	...
	Timeout *xsd.Duration `xml:"Timeout,omitempty" json:"Timeout,omitempty"`

	Items []string `xml:",any" json:"items,omitempty"`
}

type Scope struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema Scopes"`
...
type NetworkInterface struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema NetworkInterfaces"`
...
type Dot3Configuration struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema Dot3"`
...
type NetworkInterfaceLink struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema Link"`
...
type NetworkInterfaceInfo struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema Info"`
...
type IPv6NetworkInterface struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema IPv6"`
...
type IPv4NetworkInterface struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema IPv4"`
...
type IPv4Configuration struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema Config"`
...
type NetworkProtocol struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema NetworkProtocols"`
...
type NetworkInterfaceSetConfiguration struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema NetworkInterface"`
...
type Dot11Configuration struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema Dot11"`
...
type Dot11SecurityConfiguration struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema Security"`
...
type Dot11PSKSet struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema PSK"`
...
type Dot11Capabilities struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema Capabilities"`
...
type Dot11Status struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema Status"`
...
type Dot11AvailableNetworks struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema Networks"`
...
type CapabilitiesExtension2 struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema Extensions"`

	Items []string `xml:",any" json:"items,omitempty"`
}

type AnalyticsCapabilities struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema Analytics"`
...
type IOCapabilities struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema IO"`
...
type SystemCapabilities struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema System"`
...
type DeviceIOCapabilities struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema DeviceIO"`
...
type DisplayCapabilities struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema Display"`
...
type RecordingCapabilities struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema Recording"`
...
type SearchCapabilities struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema Search"`
...
type ReplayCapabilities struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema Replay"`
...
type ReceiverCapabilities struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema Receiver"`
...
type AnalyticsDeviceCapabilities struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema AnalyticsDevice"`
...
type BackupFile struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema BackupFiles"`
...
type SystemLogUriList struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema SystemLogUris"`

	SystemLog []*SystemLogUri `xml:"SystemLog,omitempty" json:"SystemLog,omitempty"`
}

type SystemLogUri struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema SystemLog"`
...
type RelayOutputSettings struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema Properties"`
	...
	DelayTime *xsd.Duration `xml:"DelayTime,omitempty" json:"DelayTime,omitempty"`
...
type RelayOutput struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema RelayOutputs"`
...
type PTZPresetTourSupported struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema SupportedPresetTour"`
...
type PTZConfiguration struct {
	*ConfigurationEntity
	...
	//
	DefaultAbsolutePantTiltPositionSpace xsd.AnyURI `xml:"DefaultAbsolutePantTiltPositionSpace,omitempty" json:"DefaultAbsolutePantTiltPositionSpace,omitempty"`

	//
	// If the PTZ Node supports absolute zoom movements, it shall specify one Absolute Zoom Position Space as default.
	//
	DefaultAbsoluteZoomPositionSpace xsd.AnyURI `xml:"DefaultAbsoluteZoomPositionSpace,omitempty" json:"DefaultAbsoluteZoomPositionSpace,omitempty"`

	//
	// If the PTZ Node supports relative Pan/Tilt movements, it shall specify one RelativePan/Tilt Translation Space as default.
	//
	DefaultRelativePanTiltTranslationSpace xsd.AnyURI `xml:"DefaultRelativePanTiltTranslationSpace,omitempty" json:"DefaultRelativePanTiltTranslationSpace,omitempty"`

	//
	// If the PTZ Node supports relative zoom movements, it shall specify one Relative Zoom Translation Space as default.
	//
	DefaultRelativeZoomTranslationSpace xsd.AnyURI `xml:"DefaultRelativeZoomTranslationSpace,omitempty" json:"DefaultRelativeZoomTranslationSpace,omitempty"`
	...
	//
	DefaultContinuousPanTiltVelocitySpace xsd.AnyURI `xml:"DefaultContinuousPanTiltVelocitySpace,omitempty" json:"DefaultContinuousPanTiltVelocitySpace,omitempty"`

	//
	// If the PTZ Node supports continuous zoom movements, it shall specify one Continuous Zoom Velocity Space as default.
	//
	DefaultContinuousZoomVelocitySpace xsd.AnyURI `xml:"DefaultContinuousZoomVelocitySpace,omitempty" json:"DefaultContinuousZoomVelocitySpace,omitempty"`
	...
	//
	DefaultPTZTimeout *xsd.Duration `xml:"DefaultPTZTimeout,omitempty" json:"DefaultPTZTimeout,omitempty"`
...
type PTControlDirectionOptions struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema PTControlDirection"`
...
type EFlipOptions struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema EFlip"`
...
type ReverseOptions struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema Reverse"`
...
type PTZPresetTourSpot struct {
	...
	StayTime *xsd.Duration `xml:"StayTime,omitempty" json:"StayTime,omitempty"`
...
type PTZPresetTourPresetDetail struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema PresetDetail"`
...
type PTZPresetTourTypeExtension struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema TypeExtension"`
...
type PTZPresetTourStartingCondition struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema StartingCondition"`
	...
	RecurringDuration *xsd.Duration `xml:"RecurringDuration,omitempty" json:"RecurringDuration,omitempty"`
...
type PTZPresetTourSpotOptions struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema TourSpot"`
...
type FocusConfiguration struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema Focus"`
...
type WideDynamicRangeOptions struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema WideDynamicRange"`
...
type BacklightCompensationOptions struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema BacklightCompensation"`
...
type ExposureOptions struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema Exposure"`
...
type WhiteBalanceOptions struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema WhiteBalance"`
...
type AbsoluteFocus struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema Absolute"`
...
type RelativeFocus struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema Relative"`
...
type ContinuousFocus struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema Continuous"`
...
type IrCutFilterAutoAdjustment struct {
	...
	ResponseTime *xsd.Duration `xml:"ResponseTime,omitempty" json:"ResponseTime,omitempty"`
...
type ImageStabilizationOptions struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema ImageStabilization"`
...
type IrCutFilterAutoAdjustmentOptions struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema IrCutFilterAutoAdjustment"`
...
type ItemList struct {
	SimpleItem []struct {
		...
		Value *AnySimpleType `xml:"http://www.onvif.org/ver10/schema Value,attr,omitempty" json:"Value,omitempty"`
...
type ItemListDescription struct {
	SimpleItemDescription []struct {
		...
		Type *xsd.QName `xml:"http://www.onvif.org/ver10/schema Type,attr,omitempty" json:"Type,omitempty"`
...
type ConfigDescription struct {
	...
	Name *xsd.QName `xml:"http://www.onvif.org/ver10/schema Name,attr,omitempty" json:"Name,omitempty"`
...
type SupportedRules struct {
	...
	RuleContentSchemaLocation []xsd.AnyURI `xml:"RuleContentSchemaLocation,omitempty" json:"RuleContentSchemaLocation,omitempty"`
...
type SupportedAnalyticsModules struct {
	...
	AnalyticsModuleContentSchemaLocation []xsd.AnyURI `xml:"AnalyticsModuleContentSchemaLocation,omitempty" json:"AnalyticsModuleContentSchemaLocation,omitempty"`
...
type ReceiverConfiguration struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema Configuration"`
...
type SourceReference struct {
	...
	Type xsd.AnyURI `xml:"http://www.onvif.org/ver10/schema Type,attr,omitempty" json:"Type,omitempty"`
}

type DateTimeRange struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema Validity"`
...
type FindEventResult struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema Result"`
...
type RecordingSourceInformation struct {
	...
	SourceId xsd.AnyURI `xml:"SourceId,omitempty" json:"SourceId,omitempty"`
	...
	Address xsd.AnyURI `xml:"Address,omitempty" json:"Address,omitempty"`
...
type RecordingConfiguration struct {
	...
	MaximumRetentionTime *xsd.Duration `xml:"MaximumRetentionTime,omitempty" json:"MaximumRetentionTime,omitempty"`
...
type GetTracksResponseList struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema Tracks"`
...
type GetTracksResponseItem struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema Track"`
...
type RecordingJobConfiguration struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema JobConfiguration"`
...
type RecordingEventFilter struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema EventFilter"`
	...
	Before *xsd.Duration `xml:"Before,omitempty" json:"Before,omitempty"`

	// Optional timespan to record after the actual event condition becomes inactive.
	After *xsd.Duration `xml:"After,omitempty" json:"After,omitempty"`
...
type RecordingJobStateSource struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema Sources"`
...
type AnalyticsDeviceEngineConfiguration struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema AnalyticsEngineConfiguration"`
...
type AnalyticsState struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema State"`
...
type AudioClassCandidate struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema ClassCandidate"`
...
type ActiveConnection struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema ActiveConnections"`
...
type OSDReference struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema VideoSourceConfigurationToken"`

	Value *ReferenceToken `xml:",chardata" json:"-,"`
}

type OSDPosConfiguration struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema Position"`
...
type OSDTextConfiguration struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema TextString"`
...
type OSDImgConfiguration struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema Image"`

	// The URI of the image which to be displayed.
	ImgPath xsd.AnyURI `xml:"ImgPath,omitempty" json:"ImgPath,omitempty"`
...
type ColorspaceRange struct {
	...
	// Acceptable values are the same as in tt:Color.
	//
	Colorspace xsd.AnyURI `xml:"Colorspace,omitempty" json:"Colorspace,omitempty"`
}

type ColorOptions struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema Color"`
...
type OSDTextOptions struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema TextOption"`
...
type OSDImgOptions struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/schema ImageOption"`

	// List of available image URIs.
	ImagePath []xsd.AnyURI `xml:"ImagePath,omitempty" json:"ImagePath,omitempty"`
