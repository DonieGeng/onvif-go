...
func (service *device) SetHashingAlgorithmContext(ctx context.Context, request *SetHashingAlgorithm) (*SetHashingAlgorithmResponse, error) {
	response := new(SetHashingAlgorithmResponse)
	err := service.client.CallContext(ctx, "''", request, response)
	if err != nil {
		return nil, err
	}
...
func (service *device) SetHashingAlgorithm(request *SetHashingAlgorithm) (*SetHashingAlgorithmResponse, error) {
	return service.SetHashingAlgorithmContext(
		context.Background(),
		request,
	)
}
